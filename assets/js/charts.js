...
/* Chart 1: HST Counts — Lead Source wise, ALL records regardless of status
   ...
   Lead Source (inner, individual bars, also alphabetical), single "Total"
   series. Date-scoped to the dashboard's selected range by the caller
   (Create Date) -- the only one of the three HST charts that is. */
